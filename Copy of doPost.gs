...
//     const keyRadio = keyboardRadiohead;
//     const row = [cbData];

//     sendKeyboardAlbomR(chatIdCb, answerAlbom, keyRadio);
//     SpreadsheetApp.getActiveSpreadsheet().getSheetByName('Sheet1').appendRow(row);
//   } else if (cbData === 'n. cave') {
//     const answerAlbom = 'chose the ALBOM';
//     const keyCave = keyboardCave;
//     const row = [cbData];

//     sendKeyboardAlbomC(chatIdCb, answerAlbom, keyCave);
//     SpreadsheetApp.getActiveSpreadsheet().getSheetByName('Sheet1').appendRow(row);
//   }
// }
